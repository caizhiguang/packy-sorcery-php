;(function($){
	...
	$.classes.ui.msgbox = $.salvia.object.Class($.classes.ui.form,{
		...
		initScreen:function(){
			this._screen = $("#Screen").length!=0?$("#Screen"):$.c("div").attr({id:"Screen"}).appendTo(document.body).append($.c("div").addClass("fuckIE").append($.c("iframe")));
			this._screen.css({
				zIndex:"998",
				position:"fixed",
				top:0,
