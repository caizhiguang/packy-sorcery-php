!function($){
	...
	$.salvia.ui.scrollable = $.salvia.object.Class($.salvia.ui.base,{
		...
		next:function(){
			if(this._index != this.dom.find(this._item).length - 1)
